...
::: {style="font-size: 85%;"}
| Type de maladie/entité | Type de question             | Caractéristiques et difficultés méthodologiques                                                                                        | Partie de l'exposé                                      |
|-------------|-------------|---------------------------------|-------------|
...
- Evolution des méthodes utilisables et utilisées pour répondre à ces questions
    - mobilisation/découverte de différentes méthodes pour différentes question
...
- Prévenir : 
    ...
    - améliorer l'efficience $\rightarrow$ prévenir les maladies, optimiser la longévité des bovins
- S'adapter :
    - stress thermique $\rightarrow$ évaluer les conséquences sur la santé et le bien-être (Projet WAIT4)
    - émergences $\rightarrow$ détecter précocement

## Perspectives : évolution des méthodes

- Nombreuses questions posées par les développements méthodologiques récents
...
- Combiner simulation et inférence
